...
function floatingPoint(){
	...
	console.log("parseFloat: ", parseFloat(a+b).toPrecision(1));
}
floatingPoint();
...
function compareEqual(){
    ...
    * Tuy nhiên chúng đều là false khi chuyển sang boolean, nên khi sử dụng ==, kết quả vẫn là true
    */
